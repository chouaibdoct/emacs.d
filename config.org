...
#+begin_src emacs-lisp :tangle yes
  (use-package citar
    :no-require
    :custom
    (org-cite-global-bibliography '("~/Documents/Zotero/MyLib.bib" "~/Documents/Zotero/MyLib2.bib" ))
    (citar-bibliography '("~/Documents/Zotero/MyLib.bib" "~/Documents/Zotero/MyLib2.bib"))
